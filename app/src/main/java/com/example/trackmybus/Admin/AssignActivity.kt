...
import com.example.trackmybus.databinding.ActivityAssignBinding
...
class AssignActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind.fulldetails.text=HtmlCompat.fromHtml(text,HtmlCompat.FROM_HTML_OPTION_USE_CSS_COLORS)
 try {
...
bind.kmcaluculation.text=HtmlCompat.fromHtml("<b>${decimal.format(km)} k/m</b>",HtmlCompat.FROM_HTML_OPTION_USE_CSS_COLORS)
}catch (e:Exception){
     bind.kmcaluculation.text=HtmlCompat.fromHtml("<b>Error :${e.message}}</b>",HtmlCompat.FROM_HTML_OPTION_USE_CSS_COLORS)
}
...
textView.text=HtmlCompat.fromHtml("<b>${String.format("%02d : %02d",i,i2)} $amorpm</b>",HtmlCompat.FROM_HTML_OPTION_USE_CSS_COLORS)
