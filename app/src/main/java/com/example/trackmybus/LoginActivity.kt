...
import com.example.trackmybus.User.ViewTheLocation
import com.example.trackmybus.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity(), Myintention {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind.createdrvier.setOnClickListener {
            bind.framelay.isVisible = true
            supportFragmentManager.beginTransaction().replace(R.id.framelay, Fragment2()).commit()
            bind.constraint3.isVisible = false
        }
