...
class ViewDoc(val context:Context,val data:ArrayList<Route>):RecyclerView.Adapter<ViewDoc.MyView>() {
    ...
    override fun onBindViewHolder(holder: MyView, position: Int) {
        ...
        holder.card.details.text=HtmlCompat.fromHtml(k,HtmlCompat.FROM_HTML_OPTION_USE_CSS_COLORS)
